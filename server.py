...
def movie_details(movie_id):
    ...
    rating_scores = [r.score for r in movie_ratings]
    ...
    if (not current_user_rating) and current_user_id:
    ...
    elif current_user_rating:
        # User has already scored for real; use that
        effective_rating = current_user_rating.score
    ...
    the_eye = User.query.filter_by(email="eye@gmail.com").one()
